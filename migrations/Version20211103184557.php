 ...
 */
final class Version20211103184557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE peinture ADD user_id INT NOT NULL, CHANGE createdat date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE peinture DROP user_id, CHANGE date CreatedAt DATETIME DEFAULT NULL');
    }
}
